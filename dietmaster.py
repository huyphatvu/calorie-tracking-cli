...
from utils import get_float_input, get_int_input, get_choice_input, kg_to_lbs, cm_to_inches, lbs_to_kg
import datetime
...
def main():
    ...
    while True:
        ...
        print("7. Exit")
        choice = get_choice_input("Enter your choice", [str(i) for i in range(1, 8)])
